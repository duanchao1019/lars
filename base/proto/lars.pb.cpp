...
PROTOBUF_CONSTEXPR ReportHostRequest::ReportHostRequest(
    ::_pbi::ConstantInitialized)
  : host_(nullptr)
  , modid_(0)
  , cmdid_(0)
...
struct ReportHostRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ReportHostRequestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ReportHostRequestDefaultTypeInternal() {}
  union {
    ReportHostRequest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ReportHostRequestDefaultTypeInternal _ReportHostRequest_default_instance_;
}  // namespace lars
...
const uint32_t TableStruct_lars_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::lars::ReportHostRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::lars::ReportHostRequest, modid_),
  PROTOBUF_FIELD_OFFSET(::lars::ReportHostRequest, cmdid_),
  PROTOBUF_FIELD_OFFSET(::lars::ReportHostRequest, host_),
  PROTOBUF_FIELD_OFFSET(::lars::ReportHostRequest, retcode_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 67, -1, -1, sizeof(::lars::ReportHostRequest)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::lars::_ReportHostRequest_default_instance_._instance,
};
...
const char descriptor_table_protodef_lars_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Info\"`\n\021ReportHostRequest\022\r\n\005modid\030\001 \001(\005"
  "\022\r\n\005cmdid\030\002 \001(\005\022\034\n\004host\030\003 \001(\0132\016.lars.Hos"
  "tInfo\022\017\n\007retcode\030\004 \001(\005*\351\001\n\tMessageId\022\r\n\t"
  "ID_UNKNOW\020\000\022\026\n\022ID_GetRouteRequest\020\001\022\027\n\023I"
  "D_GetRouteResponse\020\002\022\032\n\026ID_ReportStatusR"
  "equest\020\003\022\025\n\021ID_GetHostRequest\020\004\022\026\n\022ID_Ge"
  "tHostResponse\020\005\022\030\n\024ID_ReportHostRequest\020"
  "\006\022\032\n\026ID_API_GetRouteRequest\020\007\022\033\n\027ID_API_"
  "GetRouteResponse\020\010*T\n\013LarsRetCode\022\014\n\010RET"
  "_SUCC\020\000\022\020\n\014RET_OVERLOAD\020\001\022\024\n\020RET_SYSTEM_"
...
const ::_pbi::DescriptorTable descriptor_table_lars_2eproto = {
    false, false, 992, descriptor_table_protodef_lars_2eproto,
    "lars.proto",
...
class ReportHostRequest::_Internal {
 public:
  static const ::lars::HostInfo& host(const ReportHostRequest* msg);
};

const ::lars::HostInfo&
ReportHostRequest::_Internal::host(const ReportHostRequest* msg) {
  return *msg->host_;
}
ReportHostRequest::ReportHostRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:lars.ReportHostRequest)
}
ReportHostRequest::ReportHostRequest(const ReportHostRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_host()) {
    host_ = new ::lars::HostInfo(*from.host_);
  ...
  // @@protoc_insertion_point(copy_constructor:lars.ReportHostRequest)
}

inline void ReportHostRequest::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&host_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&retcode_) -
    reinterpret_cast<char*>(&host_)) + sizeof(retcode_));
...
ReportHostRequest::~ReportHostRequest() {
  // @@protoc_insertion_point(destructor:lars.ReportHostRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ReportHostRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete host_;
}

void ReportHostRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void ReportHostRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:lars.ReportHostRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ReportHostRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* ReportHostRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:lars.ReportHostRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lars.ReportHostRequest)
  return target;
}

size_t ReportHostRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:lars.ReportHostRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ReportHostRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    ReportHostRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ReportHostRequest::GetClassData() const { return &_class_data_; }

void ReportHostRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ReportHostRequest *>(to)->MergeFrom(
      static_cast<const ReportHostRequest &>(from));
}


void ReportHostRequest::MergeFrom(const ReportHostRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:lars.ReportHostRequest)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ReportHostRequest::CopyFrom(const ReportHostRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:lars.ReportHostRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ReportHostRequest::IsInitialized() const {
  return true;
}

void ReportHostRequest::InternalSwap(ReportHostRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReportHostRequest, retcode_)
      + sizeof(ReportHostRequest::retcode_)
      - PROTOBUF_FIELD_OFFSET(ReportHostRequest, host_)>(
          reinterpret_cast<char*>(&host_),
          reinterpret_cast<char*>(&other->host_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ReportHostRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_lars_2eproto_getter, &descriptor_table_lars_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::lars::ReportHostRequest*
Arena::CreateMaybeMessage< ::lars::ReportHostRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::lars::ReportHostRequest >(arena);
}
