...
class ReportHostRequest;
struct ReportHostRequestDefaultTypeInternal;
extern ReportHostRequestDefaultTypeInternal _ReportHostRequest_default_instance_;
...
template<> ::lars::ReportHostRequest* Arena::CreateMaybeMessage<::lars::ReportHostRequest>(Arena*);
...
class ReportHostRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lars.ReportHostRequest) */ {
 public:
  inline ReportHostRequest() : ReportHostRequest(nullptr) {}
  ~ReportHostRequest() override;
  explicit PROTOBUF_CONSTEXPR ReportHostRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ReportHostRequest(const ReportHostRequest& from);
  ReportHostRequest(ReportHostRequest&& from) noexcept
    : ReportHostRequest() {
    *this = ::std::move(from);
  }

  inline ReportHostRequest& operator=(const ReportHostRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline ReportHostRequest& operator=(ReportHostRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ReportHostRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const ReportHostRequest* internal_default_instance() {
    return reinterpret_cast<const ReportHostRequest*>(
               &_ReportHostRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(ReportHostRequest& a, ReportHostRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(ReportHostRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ReportHostRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ReportHostRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ReportHostRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ReportHostRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const ReportHostRequest& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ReportHostRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lars.ReportHostRequest";
  }
  protected:
  explicit ReportHostRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:lars.ReportHostRequest)
 private:
  class _Internal;
...
// int32 modid = 1;
inline void ReportHostRequest::clear_modid() {
  modid_ = 0;
}
inline int32_t ReportHostRequest::_internal_modid() const {
  return modid_;
}
inline int32_t ReportHostRequest::modid() const {
  // @@protoc_insertion_point(field_get:lars.ReportHostRequest.modid)
  return _internal_modid();
}
inline void ReportHostRequest::_internal_set_modid(int32_t value) {
  
  modid_ = value;
}
inline void ReportHostRequest::set_modid(int32_t value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lars.ReportHostRequest.modid)
}

// int32 cmdid = 2;
inline void ReportHostRequest::clear_cmdid() {
  cmdid_ = 0;
}
inline int32_t ReportHostRequest::_internal_cmdid() const {
  return cmdid_;
}
inline int32_t ReportHostRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lars.ReportHostRequest.cmdid)
  return _internal_cmdid();
}
inline void ReportHostRequest::_internal_set_cmdid(int32_t value) {
  
  cmdid_ = value;
}
inline void ReportHostRequest::set_cmdid(int32_t value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lars.ReportHostRequest.cmdid)
}

// .lars.HostInfo host = 3;
inline bool ReportHostRequest::_internal_has_host() const {
  return this != internal_default_instance() && host_ != nullptr;
}
inline bool ReportHostRequest::has_host() const {
  return _internal_has_host();
}
inline void ReportHostRequest::clear_host() {
  if (GetArenaForAllocation() == nullptr && host_ != nullptr) {
    delete host_;
  }
  host_ = nullptr;
}
inline const ::lars::HostInfo& ReportHostRequest::_internal_host() const {
  const ::lars::HostInfo* p = host_;
  return p != nullptr ? *p : reinterpret_cast<const ::lars::HostInfo&>(
      ::lars::_HostInfo_default_instance_);
}
inline const ::lars::HostInfo& ReportHostRequest::host() const {
  // @@protoc_insertion_point(field_get:lars.ReportHostRequest.host)
  return _internal_host();
}
inline void ReportHostRequest::unsafe_arena_set_allocated_host(
    ::lars::HostInfo* host) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(host_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:lars.ReportHostRequest.host)
}
inline ::lars::HostInfo* ReportHostRequest::release_host() {
...
inline ::lars::HostInfo* ReportHostRequest::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_release:lars.ReportHostRequest.host)
  
  ::lars::HostInfo* temp = host_;
  host_ = nullptr;
  return temp;
}
inline ::lars::HostInfo* ReportHostRequest::_internal_mutable_host() {
...
inline ::lars::HostInfo* ReportHostRequest::mutable_host() {
  ::lars::HostInfo* _msg = _internal_mutable_host();
  // @@protoc_insertion_point(field_mutable:lars.ReportHostRequest.host)
  return _msg;
}
inline void ReportHostRequest::set_allocated_host(::lars::HostInfo* host) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete host_;
  }
  ...
  host_ = host;
  // @@protoc_insertion_point(field_set_allocated:lars.ReportHostRequest.host)
}

// int32 retcode = 4;
inline void ReportHostRequest::clear_retcode() {
  retcode_ = 0;
}
inline int32_t ReportHostRequest::_internal_retcode() const {
  return retcode_;
}
inline int32_t ReportHostRequest::retcode() const {
  // @@protoc_insertion_point(field_get:lars.ReportHostRequest.retcode)
  return _internal_retcode();
}
inline void ReportHostRequest::_internal_set_retcode(int32_t value) {
  
  retcode_ = value;
}
inline void ReportHostRequest::set_retcode(int32_t value) {
  _internal_set_retcode(value);
  // @@protoc_insertion_point(field_set:lars.ReportHostRequest.retcode)
}
